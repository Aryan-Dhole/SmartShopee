/**
 * Server-side price utilities.
 * Contains genuine utility functions only — no fake data generators.
 */
...
/**
 * Estimate a base price category for a product name (used for price sanity checks)
 */
